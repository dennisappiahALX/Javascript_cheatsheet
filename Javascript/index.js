...
//creating objects by factory and constructors
...
const circle1 = createCircles(2);
const circle2 = createCircles(8);
...
function Circle(radius){
    this.radius = radius    //initializing an object
...
const another_circle = Object.assign({}, circle);

console.log(another_circle)
